...
/**
 * The control class extends the functionality of peersim.reports.GraphObserver to Distance Vector protocol.
 * The class prints nodes and edge costs into out file using DOT language.
 * PREREQUISITE, must be used for Distance Vector protocol in PeerSim.
 * @author R. Fielding
 * @version 1.0 
 * March 2018
 */
